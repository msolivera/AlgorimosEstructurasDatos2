...
public class TriePrefixAEDIIGUI extends javax.swing.JFrame {
    ...
    private TArbolTrie2 trie;
    
    /**
     * Creates new form TriePrefixAEDIIGUI
     */
    public TriePrefixAEDIIGUI() {
        String [] palabras=ManejadorArchivosGenerico.leerArchivo("src/dispositivos.txt");
        
        
        this.trie = new TArbolTrie2();
        String[] datos = {};
        String nombre;
        String ip;
    ...
    private void jtfSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfSearchKeyReleased
        ...
        LinkedList<TDispositivo> dispositivos;
        //TODO: LLENAR LISTA DE PALABRAS CON EL MÉTODO PREDECIR
        dispositivos = (LinkedList) this.trie.buscarDispositivos(jtfSearch.getText());
        for(TDispositivo dispositivo : dispositivos){
            listModel.addElement(dispositivo.getDirIP()+" - "+ dispositivo.getNombre());
        }
