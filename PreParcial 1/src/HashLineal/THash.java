...
public class THash {
    ...
    public int buscar(int unaClave){
        this.acumuladorBusquedaExito = 0;
        int tamañoMaximo = tamaño - 1;
        ...
        while(tabla[Hi] > 0){
            ...
            if(tabla[Hi] == unaClave){
                this.acumuladorBusquedaExito = contadorBusqueda;
                this.cantidadPromedioBusquedasExito[0] += this.acumuladorBusquedaExito;
                System.out.println("Se encontro la clave : " + unaClave + " con un total de " + acumuladorBusquedaExito + " comparaciones.");
                return this.acumuladorBusquedaExito;
            }
            Hi++;
            
            if(Hi == Ho){ //di la vuelta entera
                this.acumuladorBusquedaNoExito = contadorBusqueda;
                this.cantidadPromedioBusquedasSinExito[0] += this.acumuladorBusquedaNoExito;
