...
public class MainPD2 {
    ...
    public static void main(String[] args){
        MainPD2 main = new MainPD2();
        String[] aInsertar = ManejadorArchivosGenerico.leerArchivo("src/main/java/UT3PD2/claves_insertar.txt");
        String[] aBuscar = ManejadorArchivosGenerico.leerArchivo("src/main/java/UT3PD2/claves_buscar.txt");
        ...
        int contador = 0;
            for(THash tabla : tablas){
                ...
                Double factorCarga = new Double(aInsertar.length) / new Double((tabla.getTamaño()));
            ...
            ManejadorArchivosGenerico.escribirArchivo("src/main/java/UT3PD2/comparaciones.csv", archivo);
    ...
    public void imprimirBusquedas(String[] archivo,int contador,int cantidadBusquedasExito,int cantidadBusquedasSinExito,String factorCarga,THash tabla){
        ...
        String cantidadComparacionesExitoBusqueda = "Cantidad comparaciones promedio busquedas con exito: " + 
                                        tabla.cantidadPromedioBusquedasExito[0]/cantidadBusquedasExito;
        String cantidadComparacionesSinExitoBusqueda = "Cantidad comparaciones promedio busquedas sin exito: " + 
                                        tabla.cantidadPromedioBusquedasSinExito[0]/cantidadBusquedasSinExito;
        ...
        archivo[contador] = factorCarga + ";"+ tabla.cantidadPromedioBusquedasExito[0]/cantidadBusquedasExito
                + ";" + tabla.cantidadPromedioBusquedasSinExito[0]/cantidadBusquedasSinExito;
    }
    public void imprimirInserciones(String[] archivo,int contador,int cantidadInsercionesExitosas,THash tabla){
        String cantidadComparacionesInserciones = "Cantidad comparaciones promedio en inserciones realizadas: "  + tabla.cantidadPromedioInsercionesExitosas[0]/cantidadInsercionesExitosas;
        archivo[contador] += ";" + tabla.cantidadPromedioInsercionesExitosas[0]/cantidadInsercionesExitosas;
