...
public class Main {
    public static void main(String[] args){
        Main main = new Main();
        String[] aInsertar = ManejadorArchivosGenerico.leerArchivo("src/Domiciliarios/UT3/PD2/claves_insertar.txt");
        String[] aBuscar = ManejadorArchivosGenerico.leerArchivo("src/Domiciliarios/UT3/PD2/claves_buscar.txt");
        ...
        int contador = 0;
            ...
            ManejadorArchivosGenerico.escribirArchivo("src/Domiciliarios/UT3/PD2/comparaciones.csv", archivo);
