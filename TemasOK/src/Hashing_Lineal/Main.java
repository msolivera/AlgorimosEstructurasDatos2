...
public class Main {
    public static void main(String[] args) {
        ...
        String[] claves = ManejadorArchivosGenerico.leerArchivo("src/Hashing_Lineal/claves_insertar.txt");
        ...
        String[] claves_buscar = ManejadorArchivosGenerico.leerArchivo("src/Hashing_Lineal/claves_buscar.txt");
        System.out.println("");
        System.out.println("");
        ...
        String[] palabras = ManejadorArchivosGenerico.leerArchivo("src/Hashing_Lineal/claves.txt");
        System.out.println("");
        System.out.println("");
        ...
        System.out.println("IMPRIMIR LAS PALABRAS (cada clave)");
