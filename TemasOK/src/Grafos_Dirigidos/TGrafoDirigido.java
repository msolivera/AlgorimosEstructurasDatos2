...
public class TGrafoDirigido implements IGrafoDirigido {
    ...
    private Double[][] matriz_costos;
    private boolean[][] matriz_warshall;
    ...
    public TGrafoDirigido(Collection<TVertice> vertices, Collection<TArista> aristas) {
        ...
        this.matriz_costos=null;
        this.matriz_warshall=null;
    }
    ...
    public Double[][] getMatriz_costos() {
        if(this.matriz_costos==null){
            this.setMatriz_costos(UtilGrafos.obtenerMatrizCostos(vertices));
        }
        return this.matriz_costos;
    }

    private void setMatriz_costos(Double[][] matriz_costos) {
        this.matriz_costos = matriz_costos;
    }

    public boolean[][] getMatriz_warshall() {
        if(this.matriz_warshall==null){
            this.setMatriz_warshall(this.warshall());
        }
        return matriz_warshall;
    }

    private void setMatriz_warshall(boolean[][] matriz_warshall) {
        this.matriz_warshall = matriz_warshall;
    }    
    ...
    public Comparable centroDelGrafo() {
        ...
        while(it.hasNext()){
            ...
            Comparable a = this.obtenerExcentricidad(etiqueta_vertice);
    ...
    public boolean existeConexion(Comparable origen, Comparable destino){
        ...
        TVertice ori = this.buscarVertice(origen);
        TVertice des = this.buscarVertice(destino);
        boolean [][] matriz = this.getMatriz_warshall();
        if (ori!=null && des!=null && matriz!=null){
    ...
    public int numeroBacon(Comparable unaEtiqueta){
        ...
        TCaminos cami= this.todosLosCaminos("INICIO", unaEtiqueta);
        for(TCamino c : cami.getCaminos()){
            int costoCam= c.getOtrosVertices().size();
            if(costoCam<min)
                min=costoCam;
        }
        return min;
