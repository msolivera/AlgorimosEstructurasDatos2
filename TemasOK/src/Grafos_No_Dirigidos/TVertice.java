...
public class TVertice implements IVertice{
    ...
    public String bea2(){
        ...
        lista.add(this);
        TVertice aux= null;
        String temp = "ORIGEN: "+this.getEtiqueta().toString();
        int comparaciones = 0;
        ...
        System.out.println("CANTIDAD DE COMPARACIONES TOTAL: "+comparaciones);
        System.out.println("CANTIDAD DE COMPARACIONES SOBRE VÉRTICES NO VISITADOS: "+comparaciones2);
        return temp;
    }
