...
public class Shellsort {
    public static void main(String[] args) {
        ...
        //ORDEN ASCENDENTE
        int[] lista = c.ordenarPorShell(datos);
        System.out.println("\n");
        c.imprimir(lista);
        System.out.println("");
        ...
        ManejadorArchivosGenerico.escribirArchivo("src/clasificaciones/salidaShellsort.txt", salida,false);
        
        //ORDEN DESCENDENTE
        int[] lista2 = c.ordenarPorShellDesc(datos);
        System.out.println("\n");
        c.imprimir(lista2);
        System.out.println("");
        ...
        ManejadorArchivosGenerico.escribirArchivo("src/clasificaciones/salidaShellsort.txt", salida,true);
    }
}
