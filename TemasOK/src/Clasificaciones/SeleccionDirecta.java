...
public class SeleccionDirecta {
    public static void main(String[] args) {
        ...
        //ORDEN ASCENDENTE
        int[] lista = c.ordenarPorSeleccion(datos);
        System.out.println("\n");
        c.imprimir(lista);
        System.out.println("");
        ...
        ManejadorArchivosGenerico.escribirArchivo("src/clasificaciones/salidaSeleccionDirecta.txt", salida,false);
        
        //ORDEN DESCENDENTE
        int[] lista2 = c.ordenarPorSeleccionDesc(datos);
        System.out.println("\n");
        c.imprimir(lista2);
        System.out.println("");
        ...
        ManejadorArchivosGenerico.escribirArchivo("src/clasificaciones/salidaSeleccionDirecta.txt", salida,true);
    }
}
