...
public class Burbuja {
    public static void main(String[] args) {
        ...
        //ORDEN ASCENDENTE
        int[] lista = c.ordenarPorBurbuja(datos);
        System.out.println("\n");
        c.imprimir(lista);
        System.out.println("");
        ...
        ManejadorArchivosGenerico.escribirArchivo("src/clasificaciones/salidaBurbuja.txt", salida,false);
        
        //ORDEN DESCENDENTE
        int[] lista2 = c.ordenarPorBurbujaDesc(datos);
        System.out.println("\n");
        c.imprimir(lista2);
        System.out.println("");
        ...
        ManejadorArchivosGenerico.escribirArchivo("src/clasificaciones/salidaBurbuja.txt", salida,true);
    }
}
