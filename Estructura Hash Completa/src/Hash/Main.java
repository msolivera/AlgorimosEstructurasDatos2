...
public class Main {
    public static void main(String[] args) {
        ...
        String[] claves = ManejadorArchivosGenerico.leerArchivo("src/Hash/claves_insertar.txt");
        ...
        String[] claves_buscar = ManejadorArchivosGenerico.leerArchivo("src/Hash/claves_buscar.txt");
        System.out.println("");
        System.out.println("");
        ...
        String[] palabras = ManejadorArchivosGenerico.leerArchivo("src/Hash/claves.txt");
        System.out.println("");
        System.out.println("");
